...
const TOOLS = [
    {
        ...
        description: "List all Signal chats with their details including contact names, phone numbers, and message counts. Returns an array of chat objects sorted by activity.",
        inputSchema: {
            type: "object",
            properties: {
                include_empty: {
    ...
    },
    {
        ...
        description: "Retrieve messages from a specific Signal chat by contact name or group name. Supports pagination for large conversations.",
        inputSchema: {
            type: "object",
            properties: {
                chat_name: {
    ...
    },
    {
        ...
        description: "Search for specific text within messages in a Signal chat. Returns matching messages with context.",
        inputSchema: {
            type: "object",
            properties: {
                chat_name: {
